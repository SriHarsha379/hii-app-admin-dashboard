...
export default function ClubOnboarding() {
    ...
    return (
      <div className="min-h-screen bg-[#0B0B0F] flex flex-col items-center justify-center p-6 text-center space-y-12 relative overflow-hidden">
        ...
        <div className="absolute top-0 left-0 w-full h-full pointer-events-none overflow-hidden">
          ...
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[80%] h-[80%] bg-primary/[0.02] rounded-full blur-[150px]" />
        </div>
        ...
        <div className="relative z-10 space-y-10">
          <motion.div
            ...
            className="w-32 h-32 rounded-[48px] bg-primary/20 border-2 border-primary/40 flex items-center justify-center shadow-[0_0_60px_rgba(255,45,154,0.3)] mx-auto relative group"
          >
            <div className="absolute inset-2 rounded-[38px] bg-primary/10 animate-ping group-hover:block" />
          ...
          <div className="space-y-6">
            ...
            >
              <h1 className="text-5xl md:text-7xl font-black text-white tracking-tighter uppercase mb-2">
                Setup <br /> <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary to-purple-400">Complete</span>
              </h1>
            ...
            >
              Great news! Your venue profile has been successfully listed. You now have full access to your venue dashboard and event management tools.
            </motion.p>
          </div>
        ...
        <div className="w-full max-w-4xl space-y-12 relative z-10">
          <div className="text-center space-y-4">
            <motion.div
              ...
              className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-primary/10 border border-primary/20 text-xs font-black text-primary uppercase tracking-widest"
            >
            ...
            >
              Let's get your club set up. Choose how you want to proceed to access your dashboard.
            </motion.p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            >
              <div className="w-16 h-16 rounded-2xl bg-primary/10 flex items-center justify-center text-primary mb-6 group-hover:scale-110 group-hover:bg-primary group-hover:text-white transition-all shadow-[0_0_15px_rgba(255,45,154,0)] group-hover:shadow-[0_0_20px_rgba(255,45,154,0.4)]">
            ...
            >
              <div className="w-16 h-16 rounded-2xl bg-purple-500/10 flex items-center justify-center text-purple-400 mb-6 group-hover:scale-110 group-hover:bg-purple-500 group-hover:text-white transition-all shadow-[0_0_15px_rgba(168,85,247,0)] group-hover:shadow-[0_0_20px_rgba(168,85,247,0.4)]">
      ...
      <div className="min-h-screen bg-[#0B0B0F] p-6 lg:p-12">
        <div className="max-w-4xl mx-auto space-y-12">
          <button 
            ...
            className="group flex items-center gap-2 text-muted-foreground hover:text-white transition-all font-bold text-xs uppercase tracking-widest"
          >
  ...
  // Registration Flow (registerStep 1, 2, 3)
  return (
    <div className="min-h-screen bg-[#0B0B0F] p-4 lg:p-8">
      <div className="max-w-4xl mx-auto space-y-8">
        ...
        <div className="glass-card rounded-[32px] border border-white/10 shadow-2xl flex flex-col min-h-[80vh] relative">
              ...
              {[1, 2, 3].map((s) => (
                <div 
                  ...
                  className={cn(
                    ...
                    registerStep >= s ? "bg-primary shadow-[0_0_10px_rgba(255,45,154,0.5)]" : "bg-white/10"
                  )} 
                />
              ))}
            </div>
                      ...
                      <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
                        <div className="space-y-8">
                          <div className="space-y-4 group/field">
                            ...
                            <FilterDropdown
                              ...
                              options={cities?.map((c: any) => ({ label: c.name, value: c.name })) || [
                                { label: 'Mumbai District', value: 'Mumbai' },
                                { label: 'Delhi Territory', value: 'Delhi' },
                                { label: 'Bangalore Central', value: 'Bangalore' },
                        ...
                        <div className="relative rounded-[40px] overflow-hidden border border-white/5 group min-h-[300px] shadow-inner bg-[#09090B]">
                          ...
                          <div className="absolute inset-0 flex flex-col items-center justify-center bg-black/60 backdrop-blur-[2px]">
                            <div className="w-16 h-16 rounded-[24px] bg-primary/10 border border-primary/20 flex items-center justify-center mb-4 shadow-[0_0_30px_rgba(255,45,154,0.15)] group-hover:scale-110 transition-transform duration-500">
                              <MapPin className="w-8 h-8 text-primary shadow-primary fill-primary" />
                            </div>
                            <span className="text-[10px] font-black text-white/40 uppercase tracking-[0.4em] group-hover:text-primary transition-colors duration-500">Address Verified</span>
                          </div>
                  ...
                  <FormSection title="Contact Information" icon={<Mail className="w-4 h-4" />}>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                      ...
                      <RefinedField 
                        ...
                        name="contactName"
                        value={venueFormData.contactName}
                        onChange={(e: any) => setVenueFormData({ ...venueFormData, contactName: e.target.value })}
                      ...
                      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-6">
                        {venueFormData.portraits.map((url: string, idx: number) => (
                          ...
                          >
                            ...
                            <button 
                              onClick={() => {
                                const newPortraits = venueFormData.portraits.filter((_: any, i: number) => i !== idx);
                                setVenueFormData({ 
                                  ...venueFormData, 
                                  portraits: newPortraits,
                                  portrait_url: venueFormData.portrait_url === url ? (newPortraits[0] || '') : venueFormData.portrait_url
                                });
                              }}
                        ...
                        <label className="relative aspect-[3/4] rounded-[32px] border-2 border-dashed border-white/5 bg-[#09090B] hover:bg-white/[0.04] hover:border-primary/40 transition-all duration-500 flex flex-col items-center justify-center cursor-pointer group shadow-inner">
                          <div className="w-14 h-14 rounded-2xl bg-white/5 border border-white/5 flex items-center justify-center group-hover:scale-110 group-hover:rotate-6 transition-all group-hover:bg-primary/20 group-hover:shadow-[0_0_20px_rgba(255,45,154,0.2)]">
                          ...
                          <div className="mt-4 text-center">
                            ...
                            <span className="text-[8px] font-bold text-white/5 uppercase tracking-widest">Vertical Photo</span>
                          </div>
                          <input 
                            type="file" 
                            accept="image/*" 
                            ...
                            onChange={(e) => {
                              ...
                              if (file) {
                                ...
                                reader.onloadend = () => {
                                  ...
                                  setVenueFormData({ 
                                    ...venueFormData, 
                                    portraits: [...venueFormData.portraits, newUrl],
                                    portrait_url: venueFormData.portraits.length === 0 ? newUrl : venueFormData.portrait_url
                                  });
                                };
                  ...
                  <FormSection title="Gallery Photos" icon={<Layers className="w-4 h-4" />}>
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
                      {venueFormData.landscape_urls.map((url: string, idx: number) => (
                        <div key={idx} className="relative aspect-video rounded-[40px] overflow-hidden border border-white/5 bg-[#09090B] group/landscape shadow-2xl">
                          ...
                          <div className="absolute inset-0 bg-black/40 opacity-0 group-hover/landscape:opacity-100 transition-opacity flex items-center justify-center backdrop-blur-md">
                            <button 
                              onClick={() => {
                                setVenueFormData({ 
                                  ...venueFormData, 
                                  landscape_urls: venueFormData.landscape_urls.filter((_: any, i: number) => i !== idx) 
                                });
                              }}
                              className="w-14 h-14 bg-red-500/10 rounded-[24px] text-red-500 hover:scale-110 transition-all flex items-center justify-center border border-red-500/20 active:scale-95 shadow-[0_0_30px_rgba(239,68,68,0.2)]"
                            >
                      ...
                      <label className="relative aspect-video rounded-[40px] border-2 border-dashed border-white/5 bg-[#09090B] hover:bg-white/[0.04] hover:border-blue-400/40 transition-all duration-500 flex flex-col items-center justify-center cursor-pointer group overflow-hidden shadow-inner">
                        <div className="w-14 h-14 rounded-2xl bg-white/5 border border-white/5 flex items-center justify-center group-hover:scale-110 transition-all group-hover:bg-blue-400/20 group-hover:shadow-[0_0_20px_rgba(96,165,250,0.2)]">
                          ...
                          onChange={(e) => {
                            ...
                            if (file) {
                              ...
                              reader.onloadend = () => {
                                setVenueFormData({ 
                                  ...venueFormData, 
                                  landscape_urls: [...venueFormData.landscape_urls, reader.result as string] 
                                });
                              };
                              reader.readAsDataURL(file);
                            }
          ...
          <div className="p-10 lg:p-14 border-t border-white/5 bg-white/[0.02] flex items-center justify-between relative z-10">
            <button 
              onClick={() => registerStep === 1 ? setStep('options') : setRegisterStep(s => s - 1)}
              className="px-10 py-5 rounded-[24px] bg-white/5 border border-white/10 text-[10px] font-black uppercase tracking-[0.3em] text-white/60 hover:text-white hover:bg-white/10 transition-all flex items-center gap-4 active:scale-95 transition-all"
            >
